...
class Binomial(Distribution):
    ...
    def log_prob(self, value):
        ...
        log_factorial_n = tensorplay.lgamma(self.total_count + 1)
        log_factorial_k = tensorplay.lgamma(value + 1)
        log_factorial_nmk = tensorplay.lgamma(self.total_count - value + 1)
        ...
        normalize_term = (
            ...
            + self.total_count * tensorplay.log1p(tensorplay.exp(-tensorplay.abs(self.logits)))
            - log_factorial_n
        )
        return (
    ...
    def entropy(self):
        ...
        return -(tensorplay.exp(log_prob) * log_prob).sum(0)
