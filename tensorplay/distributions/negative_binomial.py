...
class NegativeBinomial(Distribution):
    ...
    def mean(self) -> Tensor:
        return self.total_count * tensorplay.exp(self.logits)
    ...
    def variance(self) -> Tensor:
        return self.mean / tensorplay.sigmoid(-self.logits)
    ...
    def _gamma(self) -> Gamma:
        ...
        return Gamma(
            ...
            rate=tensorplay.exp(-self.logits),
            validate_args=False,
        )
    ...
    def sample(self, sample_shape=tensorplay.Size()):
        with tensorplay.no_grad():
            ...
            return tensorplay.poisson(rate)
    ...
    def log_prob(self, value):
        ...
        log_normalization = (
            -tensorplay.lgamma(self.total_count + value)
            + tensorplay.lgamma(1.0 + value)
            + tensorplay.lgamma(self.total_count)
        )
