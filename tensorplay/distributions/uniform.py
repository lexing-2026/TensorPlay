...
class Uniform(Distribution):
    ...
    def rsample(self, sample_shape: _size = tensorplay.Size()) -> Tensor:
        ...
        rand = tensorplay.rand(shape, dtype=self.low.dtype, device=self.low.device)
    ...
    def log_prob(self, value):
        ...
        return tensorplay.log(lb.mul(ub)) - tensorplay.log(self.high - self.low)
    ...
    def entropy(self):
        return tensorplay.log(self.high - self.low)
