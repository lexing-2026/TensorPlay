...
from tensorplay.distributions.cauchy import Cauchy
from tensorplay.distributions.transformed_distribution import TransformedDistribution
from tensorplay.distributions.transforms import AbsTransform
...
class HalfCauchy(TransformedDistribution):
    ...
    def mode(self) -> Tensor:
        return tensorplay.zeros_like(self.scale)
