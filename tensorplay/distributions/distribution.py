...
from tensorplay.distributions.utils import lazy_property, _is_all_true
from tensorplay.distributions._types import _size
...
class Distribution:
    ...
    def __init__(
        self,
        batch_shape: tensorplay.Size = tensorplay.Size(),
        event_shape: tensorplay.Size = tensorplay.Size(),
    ...
    def expand(self, batch_shape: _size, _instance=None):
        ...
        `batch_shape`. This method calls :class:`~tensorplay.Tensor.expand` on
    ...
    @property
    def batch_shape(self) -> tensorplay.Size:
        """
    ...
    @property
    def event_shape(self) -> tensorplay.Size:
        """
    ...
    def arg_constraints(self) -> dict[str, constraints.Constraint]:
        ...
        :class:`~tensorplay.distributions.constraints.Constraint` objects that
    ...
    def support(self) -> constraints.Constraint | None:
        """
        Returns a :class:`~tensorplay.distributions.constraints.Constraint` object
    ...
    def sample(self, sample_shape: _size = tensorplay.Size()) -> Tensor:
        """
    ...
    def sample_n(self, n: int) -> Tensor:
        ...
        """
        return self.sample(tensorplay.Size((n,)))
    ...
    def perplexity(self) -> Tensor:
        ...
        Returns:
            Tensor of shape batch_shape.
        """
        return tensorplay.exp(self.entropy())

    def _extended_shape(self, sample_shape: _size = tensorplay.Size()) -> tensorplay.Size:
        """
        ...
        Args:
            sample_shape (tensorplay.Size): the size of the sample to be drawn.
        """
        if not isinstance(sample_shape, tensorplay.Size):
            sample_shape = tensorplay.Size(sample_shape)
        return tensorplay.Size(sample_shape + self._batch_shape + self._event_shape)
