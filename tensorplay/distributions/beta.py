...
from tensorplay.distributions.dirichlet import Dirichlet
...
class Beta(ExponentialFamily):
    ...
    def __init__(
        ...
        if isinstance(concentration1, _Number) and isinstance(concentration0, _Number):
            concentration1_concentration0 = tensorplay.tensor(
            ...
            concentration1_concentration0 = tensorplay.stack(
    ...
    def log_prob(self, value):
        ...
        heads_tails = tensorplay.stack([value, 1.0 - value], -1)
    ...
    def concentration1(self) -> Tensor:
        ...
        if isinstance(result, _Number):
            return tensorplay.tensor([result])
        else:
            return result
    ...
    def _log_normalizer(self, x, y):
        return tensorplay.lgamma(x) + tensorplay.lgamma(y) - tensorplay.lgamma(x + y)
