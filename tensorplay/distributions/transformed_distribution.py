...
from tensorplay.distributions.independent import Independent
from tensorplay.distributions.transforms import ComposeTransform, Transform
from tensorplay.distributions.utils import _sum_rightmost
...
class TransformedDistribution(Distribution):
    ...
    :class:`~tensorplay.distributions.gumbel.Gumbel`,
    :class:`~tensorplay.distributions.half_cauchy.HalfCauchy`,
    :class:`~tensorplay.distributions.half_normal.HalfNormal`,
    :class:`~tensorplay.distributions.log_normal.LogNormal`,
    :class:`~tensorplay.distributions.pareto.Pareto`,
    :class:`~tensorplay.distributions.weibull.Weibull`,
    :class:`~tensorplay.distributions.relaxed_bernoulli.RelaxedBernoulli` and
    :class:`~tensorplay.distributions.relaxed_categorical.RelaxedOneHotCategorical`
    """
