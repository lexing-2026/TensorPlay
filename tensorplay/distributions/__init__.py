...
parameters, we only need :meth:`~tensorplay.distributions.Distribution.sample` and
:meth:`~tensorplay.distributions.Distribution.log_prob` to implement REINFORCE:
...
:meth:`~tensorplay.distributions.Distribution.rsample` method, where the
