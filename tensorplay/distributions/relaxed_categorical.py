...
from tensorplay.distributions.transforms import ExpTransform
from tensorplay.distributions.utils import broadcast_all, clamp_probs
...
class ExpRelaxedCategorical(Distribution):
    ...
    See also: :func:`tensorplay.distributions.OneHotCategorical`
    ...
    def rsample(self, sample_shape: _size = tensorplay.Size()) -> Tensor:
        ...
        uniforms = clamp_probs(
            tensorplay.rand(shape, dtype=self.logits.dtype, device=self.logits.device)
        )
    ...
    def log_prob(self, value):
        ...
        log_scale = tensorplay.full_like(
