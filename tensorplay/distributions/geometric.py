...
from tensorplay.distributions._types import _Number, Number
...
class Geometric(Distribution):
    ...
    .. note::
        :func:`tensorplay.distributions.geometric.Geometric` :math:`(k+1)`-th trial is the first success
        hence draws samples in :math:`\{0, 1, \ldots\}`, whereas
        :func:`tensorplay.Tensor.geometric_` `k`-th trial is the first success hence draws samples in :math:`\{1, 2, \ldots\}`.
    ...
    def mode(self) -> Tensor:
        return tensorplay.zeros_like(self.probs)
    ...
    def sample(self, sample_shape=tensorplay.Size()):
        ...
        tiny = tensorplay.finfo(self.probs.dtype).tiny
    ...
    def log_prob(self, value):
        ...
        probs = probs.clone(memory_format=tensorplay.contiguous_format)
