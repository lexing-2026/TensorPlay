...
from tensorplay.distributions.categorical import Categorical
...
class OneHotCategorical(Distribution):
    ...
    See also: :func:`tensorplay.distributions.Categorical` for specifications of
    ...
    def mode(self) -> Tensor:
        ...
        return tensorplay.nn.functional.one_hot(mode, num_classes=probs.shape[-1]).to(probs)
    ...
    def sample(self, sample_shape=tensorplay.Size()):
        ...
        return tensorplay.nn.functional.one_hot(indices, num_events).to(probs)
    ...
    def enumerate_support(self, expand=True):
        ...
        values = tensorplay.eye(n, dtype=self._param.dtype, device=self._param.device)
