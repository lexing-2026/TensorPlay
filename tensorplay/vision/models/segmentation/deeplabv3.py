...
from tensorplay.nn import Module, Sequential
...
from ..resnet import ResNet, ResNet101_Weights, ResNet50_Weights, resnet101, resnet50
...
class DeepLabV3(_SimpleSegmentationModel):
    """DeepLabV3 dense prediction model built on a multi-rate atrous encoder.

    Args:
        backbone (Module): maps the input image to feature maps, returning a
            dict with the key ``"out"`` (and ``"aux"`` when an auxiliary
            classifier is used).
        classifier (Module): maps the ``"out"`` feature map to a dense
            prediction.
        aux_classifier (Module, optional): auxiliary classifier used during
            training.
    """
...
class ASPP(Module):
    """Atrous spatial pyramid pooling: parallel 1x1, multi-rate 3x3 and
    global-pooling branches fused by a 1x1 projection."""
    ...
    def forward(self, x: Tensor) -> Tensor:
        res = tensorplay.cat([conv(x) for conv in self.convs], dim=1)
...
def _deeplabv3_mobilenetv3(
    ...
    # always included as C0 and C5.
    stage_indices = [0] + [i for i, b in enumerate(backbone) if getattr(b, "_is_cn", False)] + [len(backbone) - 1]
    out_pos = stage_indices[-1]  # C5, output_stride 16
    out_inplanes = backbone[out_pos].out_channels
    aux_pos = stage_indices[-4]  # C2, output_stride 8
...
def _deeplabv3_resnet50(
    *,
    ...
    weights_backbone: Optional[ResNet50_Weights],
    **kwargs: Any,
) -> DeepLabV3:
...
def _deeplabv3_resnet101(
    *,
    weights: Optional[DeepLabV3_ResNet101_Weights],
    progress: bool,
    num_classes: Optional[int],
    aux_loss: Optional[bool],
    weights_backbone: Optional[ResNet101_Weights],
    **kwargs: Any,
) -> DeepLabV3:
...
def deeplabv3_resnet50(
    ...
    **kwargs: Any,
    ...
    """DeepLabV3 model with a ResNet-50 backbone from
    `Rethinking Atrous Convolution for Semantic Image Segmentation <https://arxiv.org/abs/1706.05587>`__.

    Args:
        weights (:class:`~tensorplay.vision.models.segmentation.DeepLabV3_ResNet50_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.segmentation.DeepLabV3_ResNet50_Weights` below for
        ...
        weights_backbone (:class:`~tensorplay.vision.models.ResNet50_Weights`, optional): The pretrained
            weights for the backbone.
        **kwargs: parameters passed to the ``tensorplay.vision.models.segmentation.deeplabv3.DeepLabV3``
            base class.
    """
    return _deeplabv3_resnet50(
        weights=weights,
        progress=progress,
...
def deeplabv3_resnet101(
    ...
    **kwargs: Any,
    ...
    """DeepLabV3 model with a ResNet-101 backbone from
    `Rethinking Atrous Convolution for Semantic Image Segmentation <https://arxiv.org/abs/1706.05587>`__.

    Args:
        weights (:class:`~tensorplay.vision.models.segmentation.DeepLabV3_ResNet101_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.segmentation.DeepLabV3_ResNet101_Weights` below for
            more details, and possible values. By default, no pre-trained
            weights are used.
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
        num_classes (int, optional): number of output classes of the model (including the background).
        aux_loss (bool, optional): If True, it uses an auxiliary loss.
        weights_backbone (:class:`~tensorplay.vision.models.ResNet101_Weights`, optional): The pretrained
            weights for the backbone.
        **kwargs: parameters passed to the ``tensorplay.vision.models.segmentation.deeplabv3.DeepLabV3``
            base class.
    """
    return _deeplabv3_resnet101(
        weights=weights,
        progress=progress,
        num_classes=num_classes,
        aux_loss=aux_loss,
...
def deeplabv3_mobilenet_v3_large(
    ...
    **kwargs: Any,
    ...
    """DeepLabV3 model with a MobileNetV3-Large backbone from
    `Searching for MobileNetV3 <https://arxiv.org/abs/1905.02244>`__.

    Args:
        weights (:class:`~tensorplay.vision.models.segmentation.DeepLabV3_MobileNet_V3_Large_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.segmentation.DeepLabV3_MobileNet_V3_Large_Weights` below for
            more details, and possible values. By default, no pre-trained
            weights are used.
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
