...
class FCN(_SimpleSegmentationModel):
    """Fully convolutional network for dense per-pixel classification.
...
def fcn_resnet50(
    ...
    **kwargs: Any,
    ...
    """Fully-Convolutional Network model with a ResNet-50 backbone from
    `Fully Convolutional Networks for Semantic Segmentation <https://arxiv.org/abs/1411.4038>`__.

    Args:
        weights (:class:`~tensorplay.vision.models.segmentation.FCN_ResNet50_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.segmentation.FCN_ResNet50_Weights` below for
        ...
        **kwargs: parameters passed to the ``tensorplay.vision.models.segmentation.fcn.FCN``
            base class.
    """
...
def fcn_resnet101(
    ...
    **kwargs: Any,
    ...
    """Fully-Convolutional Network model with a ResNet-101 backbone from
    `Fully Convolutional Networks for Semantic Segmentation <https://arxiv.org/abs/1411.4038>`__.

    Args:
        weights (:class:`~tensorplay.vision.models.segmentation.FCN_ResNet101_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.segmentation.FCN_ResNet101_Weights` below for
            more details, and possible values. By default, no pre-trained
            weights are used.
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
