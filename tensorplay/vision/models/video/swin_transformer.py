...
def _get_relative_position_bias(
    ...
    relative_position_bias = relative_position_bias_table[
        relative_position_index[:window_vol, :window_vol].flatten()
    ]
...
def shifted_window_attention_3d(
    ...
    # cyclic shift
    if sum(shift_size) > 0:
        x = tensorplay.roll(x, shifts=(-shift_size[0], -shift_size[1], -shift_size[2]), dims=(1, 2, 3))
    # partition windows
    num_windows = (
...
class ShiftedWindowAttention3d(nn.Module):
    ...
    def define_relative_position_index(self) -> None:
        ...
        coords_dhw = [tensorplay.arange(self.window_size[i]) for i in range(3)]
        coords = tensorplay.stack(
            tensorplay.meshgrid(coords_dhw, indexing="ij")
        )  # 3, Wd, Wh, Ww
        coords_flatten = tensorplay.flatten(coords, 1)  # 3, Wd*Wh*Ww
    ...
    def get_relative_position_bias(self, window_size: list[int]) -> Tensor:
        return _get_relative_position_bias(
            self.relative_position_bias_table, self.relative_position_index, window_size
        )
...
class SwinTransformer3d(nn.Module):
    """3D Swin Transformer from the `Video Swin Transformer <https://arxiv.org/abs/2106.13230>`_ paper.
...
def swin3d_t(*, weights: Optional[Swin3D_T_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer3d:
    """Swin-tiny 3D architecture from
    `Video Swin Transformer <https://arxiv.org/abs/2106.13230>`_.

    Args:
        weights (:class:`~tensorplay.vision.models.video.Swin3D_T_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.video.Swin3D_T_Weights` below for
            more details, and possible values. By default, no pre-trained
            weights are used.
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
        **kwargs: parameters passed to the ``tensorplay.vision.models.video.swin_transformer.SwinTransformer3d``
            base class.
    """
...
def swin3d_s(*, weights: Optional[Swin3D_S_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer3d:
    """Swin-small 3D architecture from
    `Video Swin Transformer <https://arxiv.org/abs/2106.13230>`_.

    Args:
        weights (:class:`~tensorplay.vision.models.video.Swin3D_S_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.video.Swin3D_S_Weights` below for
            more details, and possible values. By default, no pre-trained
            weights are used.
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
...
def swin3d_b(*, weights: Optional[Swin3D_B_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer3d:
    """Swin-base 3D architecture from
    `Video Swin Transformer <https://arxiv.org/abs/2106.13230>`_.

    Args:
        weights (:class:`~tensorplay.vision.models.video.Swin3D_B_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.video.Swin3D_B_Weights` below for
            more details, and possible values. By default, no pre-trained
            weights are used.
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
