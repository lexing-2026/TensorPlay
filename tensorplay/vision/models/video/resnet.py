...
class Conv2Plus1D(nn.Sequential):
    """Spatio-temporal convolution factored into a spatial (1,3,3) pass followed
    by a temporal (3,1,1) pass, with a nonlinearity in between."""
...
class R2Plus1dStem(nn.Sequential):
    """R(2+1)D stem: the 3D convolution is separated into spatial and temporal passes."""
...
class VideoResNet(nn.Module):
    def __init__(
        ...
        """Generic residual network over video.
        ...
        Args:
            ...
            stem (Callable[..., nn.Module]): module specifying the network stem.
...
def r3d_18(*, weights: Optional[R3D_18_Weights] = None, progress: bool = True, **kwargs: Any) -> VideoResNet:
    """18 layer Resnet3D model from
    `A Closer Look at Spatiotemporal Convolutions for Action Recognition <https://arxiv.org/abs/1711.11248>`__.

    Args:
        weights (:class:`~tensorplay.vision.models.video.R3D_18_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.video.R3D_18_Weights`
            below for more details, and possible values. By default, no
            pre-trained weights are used.
        progress (bool): If True, displays a progress bar of the download to stderr. Default is True.
        **kwargs: parameters passed to the ``tensorplay.vision.models.video.resnet.VideoResNet`` base class.
    """
...
def mc3_18(*, weights: Optional[MC3_18_Weights] = None, progress: bool = True, **kwargs: Any) -> VideoResNet:
    """18 layer Mixed Convolution network from
    `A Closer Look at Spatiotemporal Convolutions for Action Recognition <https://arxiv.org/abs/1711.11248>`__.

    Args:
        weights (:class:`~tensorplay.vision.models.video.MC3_18_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.video.MC3_18_Weights`
            below for more details, and possible values. By default, no
            pre-trained weights are used.
        progress (bool): If True, displays a progress bar of the download to stderr. Default is True.
        **kwargs: parameters passed to the ``tensorplay.vision.models.video.resnet.VideoResNet`` base class.
...
def r2plus1d_18(*, weights: Optional[R2Plus1D_18_Weights] = None, progress: bool = True, **kwargs: Any) -> VideoResNet:
    """18 layer deep R(2+1)D network from
    `A Closer Look at Spatiotemporal Convolutions for Action Recognition <https://arxiv.org/abs/1711.11248>`__.

    Args:
        weights (:class:`~tensorplay.vision.models.video.R2Plus1D_18_Weights`, optional): The
            pretrained weights to use. See
            :class:`~tensorplay.vision.models.video.R2Plus1D_18_Weights`
            below for more details, and possible values. By default, no
            pre-trained weights are used.
        progress (bool): If True, displays a progress bar of the download to stderr. Default is True.
        **kwargs: parameters passed to the ``tensorplay.vision.models.video.resnet.VideoResNet`` base class.
