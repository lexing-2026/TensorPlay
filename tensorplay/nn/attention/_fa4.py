...
class _FA4Handle:
    ...
    def remove(self) -> None:
        self.library = None
        tensorplay._C._set_sdp_use_fa4(False)
...
def register_flash_attention_fa4(
    ...
    """
    Register FA4 flash attention kernels with the dispatcher.
    ...
    tensorplay._C._set_sdp_use_fa4(True)
    return handle
...
def _fa4_register_kernels() -> Library:
    ...
    lib.impl("_flash_attention_backward", _fa4_flash_attention_backward_impl,
             dispatch_key="CUDA")
    lib.impl(
...
def _fa4_common_support_error(
    ...
    require_fp32: tuple[tuple[str, tensorplay.Tensor], ...] = (),
) -> str | None:
    ...
    for name, tensor in require_fp32:
        if tensor.dtype != tensorplay.float32:
