...
class DiGraph:
    """A small unweighted directed graph used to track dependencies.

    Only the handful of operations needed by the packager are provided:
    adding nodes/edges, walking successors/predecessors, and a few
    reachability queries. Node objects must be valid dict keys.
    """
    ...
    def all_paths(self, src: str, dst: str):
        ...
        # backward_transitive_closure is not used here to keep the walk cheap.
