...
class Importer(ABC):
    ...
    tensorplay.package introduces module importers other than the default one.
    ...
    def get_name(self, obj: Any, name: str | None = None) -> tuple[str, str]:
        ...
        # PackageImporter, `__module__` will be mangled. See _mangling for
        # details.
    ...
    def whichmodule(self, obj: Any, name: str) -> str:
        ...
        Based on the classic pickle.py approach, but modified to exclude the
        search into sys.modules.
        """
...
class _SysImporter(Importer):
    ...
    def whichmodule(self, obj: Any, name: str) -> str:
        ...
        # which fails for mangled package names like '<tensorplay_package_0>'.
...
class OrderedImporter(Importer):
    ...
    def _is_package_dummy(self, module):
        """Returns true iff this module is an empty placeholder node in a package.
        ...
        """
        if not getattr(module, "__tensorplay_package__", False):
            return False
    ...
    def import_module(self, module_name: str) -> ModuleType:
        ...
        for importer in self._importers:
            ...
            try:
                ...
                if self._is_package_dummy(module):
                    continue
                return module
