...
def _build_unary_map(names, factory):
...
NATIVE_UNARY_MAP = _build_unary_map(UNARY_NAMES, _tp_unary)
NATIVE_INPLACE_UNARY_MAP = _build_unary_map(INPLACE_UNARY_NAMES, _tp_inplace_unary)
