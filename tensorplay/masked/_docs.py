...
"""Documentation strings for the masked operations.

Each ``<operation>_docstring`` attribute below is the rendered description of
the corresponding masking-aware operation in this package. The text is
regenerated from the templates in ``tensorplay.masked._ops._generate_docstring``
by the documentation workflow of this repository.
"""

sum_docstring = """\
sum(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
prod_docstring = """\
prod(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
cumsum_docstring = """\
cumsum(input, dim, *, dtype=None, mask=None) -> Tensor
...
amin_docstring = """\
amin(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
and int32 dtypes, the identity values are ``tensor(inf)``, ``tensor(Tensor(shape=tensorplay.Size(), dtype=UInt8, device=cpu)``, and ``tensor(2147483647, dtype=Int32)``, respectively.
...
amax_docstring = """\
amax(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
reduction, depends on input dtype. For instance, for float32, uint8,
and int32 dtypes, the identity values are ``tensor(-inf)``, ``tensor(Tensor(shape=tensorplay.Size(), dtype=UInt8, device=cpu)``, and ``tensor(-2147483648, dtype=Int32)``, respectively.
...
argmax_docstring = """\
argmax(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
argmin_docstring = """\
argmin(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
mean_docstring = """\
mean(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
median_docstring = """\
median(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
norm_docstring = """\
norm(input, ord, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
reduction, is ``tensor(0.)``, except for ``ord=-inf`` it is
``tensor(inf)``.
...
var_docstring = """\
var(input, dim, unbiased, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
logsumexp_docstring = """\
logsumexp(input, dim, *, keepdim=False, dtype=None, mask=None) -> Tensor
...
softmin_docstring = """\
softmin(input, dim, *, dtype=None, mask=None) -> Tensor
...
normalize_docstring = """\
normalize(input, ord, dim, *, eps=1e-12, dtype=None, mask=None) -> Tensor
